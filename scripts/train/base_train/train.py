...
if __name__ == '__main__':
    ...
    supported_cfg = {
        ...
        'bridgedp_p0_no_scale_cond': [bridgedp_p0_no_scale_cond_exp_cfg, "BridgeDP_Policy"],
        'bridgedp_p0_no_anchor_train': [bridgedp_p0_no_anchor_train_exp_cfg, "BridgeDP_Policy"],
        'bridgedp_p0_no_gcs': [bridgedp_p0_no_gcs_exp_cfg, "BridgeDP_Policy"],
