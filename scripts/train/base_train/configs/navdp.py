...
navdp_exp_cfg = ExpCfg(
    ...
    il=IlCfg(
        ...
        lr=1e-4,  # 基础学习率。
        num_workers=8,  # DataLoader 工作进程数；受 CPU 核数与磁盘吞吐影响。
        ...
        dataset_r2r_root_dir='/home/monika/dyishere/dataset/InternData/N1/InternData-N1-v0.5-mini/vln_pe/raw_data/r2r',  # R2R 原始数据根目录。
        ...
        lerobot_features_dir='/home/monika/dyishere/dataset/InternData/N1/InternData-N1-v0.5-mini/vln_pe/traj_data/r2r',  # LeRobot 特征路径（非 navdp 分支常用）。
        camera_name='pano_camera_0',  # 相机名称约定（用于特征选择/兼容字段）。
        report_to='tensorboard',  # 日志后端：wandb / tensorboard / none。
        dataset_navdp='checkpoints/preload_index.json',  # NavDP 预索引文件路径。
        root_dir='/home/monika/dyishere/dataset/InternData/N1/InternData-N1-v0.5-mini/vln_n1/traj_data',  # NavDP 轨迹数据根目录。
