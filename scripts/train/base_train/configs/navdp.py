...
navdp_exp_cfg = ExpCfg(
    ...
    il=IlCfg(
        ...
        dataset_r2r_root_dir='/home/monika/dyishere/dataset/InternData/N1/InternData-N1-v0.1-mini/vln_pe/raw_data/r2r',  # R2R 原始数据根目录。
        ...
        lerobot_features_dir='/home/monika/dyishere/dataset/InternData/N1/InternData-N1-v0.1-mini/vln_pe/traj_data/r2r',  # LeRobot 特征路径（非 navdp 分支常用）。
        ...
        root_dir='/home/monika/dyishere/dataset/InternData/N1/InternData-N1-v0.1-mini/vln_n1/traj_data',  # NavDP 轨迹数据根目录。
