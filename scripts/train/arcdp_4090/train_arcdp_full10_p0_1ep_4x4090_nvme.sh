...
export BRIDGEDP_GRAD_ACCUM="${BRIDGEDP_GRAD_ACCUM:-6}"
...
run_stage "arcdp_full10_4x4090_nvme" --model-name bridgedp_full_4x4090

export BRIDGEDP_EPOCHS=1
run_stage "arcdp_p0_rel_1ep_4x4090_nvme" --model-name bridgedp_p0_rel
run_stage "arcdp_p0_no_bridge_1ep_4x4090_nvme" --model-name bridgedp_p0_no_bridge
run_stage "arcdp_p0_no_ordered_init_1ep_4x4090_nvme" --model-name bridgedp_p0_no_ordered_init
run_stage "arcdp_p0_no_scale_cond_1ep_4x4090_nvme" --model-name bridgedp_p0_no_scale_cond
run_stage "arcdp_p0_no_anchor_train_1ep_4x4090_nvme" --model-name bridgedp_p0_no_anchor_train
run_stage "arcdp_p0_no_gcs_1ep_4x4090_nvme" --model-name bridgedp_p0_no_gcs
